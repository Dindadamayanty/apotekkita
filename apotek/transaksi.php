    ...
    <fieldset>
                        ...
                        <table cellpadding="5" class="tabel1 inside">
                            ...
                            <!-- <tr>
                                <td><input type="hidden" name="id"></td>
                                 id untuk transaksi yang merupakan primary  key pada database, dan di hidden agar tidak muncul di fieldset. Dan dipanggil lagi ketika membuat file update.
                            </tr> -->
                            <tr>
                                <td class="judulinput">
                            ...
                            <tr>
                                <td class="judulinput"><input type="text" name="jumlahobat" required="required">
        ...
        <table border="1" class="tabel2">
            ...
            <tr>
                ...
                <td><?=$a?></td>
                <td><a href="edittransaksi.php?id=<?=$datatransaksi["id"];?>">Edit</a> |
                <a href ="hapustrans.php?id=<?= $datatransaksi["id"];?>">Hapus</a>
                </td>
            </tr>
